...
@php
    $classes =
        $active ?? false
            ? 'inline-flex items-center px-1 pt-1 border-b-2 border-yellow-600/70 text-sm font-medium leading-5 text-gray-300 hover:text-gray-100 focus:outline-none focus:text-gray-100 focus:border-yellow-700/70 transition duration-150 ease-in-out'
